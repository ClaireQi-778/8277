...
@NamedQuery(name = "Course.findAll", query = "SELECT c FROM Course c LEFT JOIN FETCH c.courseRegistrations")
//TODO C02 - Do we need a mapped super class?  If so, which one? yes, use pojobase.java.
