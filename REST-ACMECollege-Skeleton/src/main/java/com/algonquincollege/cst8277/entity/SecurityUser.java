...
@NamedQuery(name = "SecurityUser.userByName", query = "SELECT su FROM SecurityUser su LEFT JOIN FETCH su.roles LEFT JOIN FETCH su.student WHERE su.username = :param1")
@NamedQuery(name = "SecurityUser.userByStudentId", query = "SELECT su FROM SecurityUser su LEFT JOIN FETCH su.roles LEFT JOIN FETCH su.student WHERE su.student.id = :param1")
