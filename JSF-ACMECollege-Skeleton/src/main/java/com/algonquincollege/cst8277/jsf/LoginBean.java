...
public class LoginBean implements Serializable, MyConstants {
    ...
    @Inject
    private StudentClubController studentClubController;
    @Inject
    ...
    */
    ...
    public void validateUsernamePassword() {
        ...
        switch (status) {
            ...
            case SEND_FAILURE:
                ...
                break;
            case SUCCESS:
                // Reinitialize all controllers with authenticated credentials
    ...
    private void reinitializeControllers() {
        ...
        professorController.initialize();
        studentClubController.initialize();
        courseRegistrationController.initialize();
    }
