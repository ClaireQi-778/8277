...
public class StudentController implements Serializable, MyConstants {
    ...
    public void loadStudents() {
        ...
        if (response.getStatus() == 200) {
            ...
            System.out.println("Failed to load students. Status: " + response.getStatus());
            String errorBody = response.readEntity(String.class);
            System.out.println("Error response: " + errorBody);
            listOfStudents = new java.util.ArrayList<>();
        }
    }
    ...
    public String addNewStudent(Student theNewStudent) {
        ...
        if (response.getStatus() == 200 || response.getStatus() == 201) {
            ...
            facesContext.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, 
                "Failed to add student. Status: " + response.getStatus(), null));
        }
        return null; //current page
    }
